...
public class CtrlInvoice {
	...
	@PostMapping
	@Operation(summary = "Creación de factura", description = "Cliente crea una factura. Opcionalmente puede indicar dirección de envío, información de pago y cupón de descuento.")
	public ResponseEntity<ApiResponse> create(@Valid @RequestBody(required = false) CheckoutRequest request){
